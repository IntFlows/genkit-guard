...
In v0.0.14, `models.extractor` controls both preloading and runtime analysis. Previously runtime analysis always used MiniLM. Custom models must support the Transformers.js feature-extraction pipeline with mean pooling and normalized embeddings.
